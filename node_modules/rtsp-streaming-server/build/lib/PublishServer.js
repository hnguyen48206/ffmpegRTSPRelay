...
class PublishServer {
    ...
    req.on('end', async () => {
      ...
      try {
        ...
        let addResult = await axios({
          url: 'http://live555_proxy:1234/add_stream',
          headers: {},
          data: {
            "input_url": req.uri.replace('127.0.0.1:9000', 'node_rtsp_proxy:9001')
          },
          method: 'POST'
        });
        ...
        if (addResult.data.streamID != null) {
          addResult = await axios({
            url: 'http://live555_proxy:1234/remove_stream',
            headers: {},
            data: {
  ...
  teardownRequest(req, res) {
    ...
    //     headers: {},
    //     data: {
    //       "input_url": req.uri.replace('9000', '9001')
    //     },
    //     method: 'POST'
    //   });
    //   console.log(addResult.data)
